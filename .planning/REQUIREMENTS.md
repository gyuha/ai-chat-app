...
- [ ] **CONV-01**: 사용자가 "새 대화" 버튼으로 새 대화를 시작할 수 있다
- [ ] **CONV-02**: 앱이 대화 목록을 최신순으로 표시한다
- [ ] **CONV-03**: 앱이 대화 제목을 첫 메시지 기반으로 자동 생성한다
- [ ] **CONV-04**: 사용자가 대화 제목을 수동 편집할 수 있다
- [ ] **CONV-05**: 사용자가 대화를 삭제할 수 있다 (확인 다이얼로그 포함)
- [ ] **CONV-06**: 모바일에서 사이드바를 토글할 수 있다
