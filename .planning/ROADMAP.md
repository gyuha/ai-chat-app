...
**Plans**: 3 plans
**Plan List:**
- [x] 02-01-PLAN.md — Wave 1: IndexedDB Persistence (Dexie liveQuery hooks, UI store)
- [x] 02-02-PLAN.md — Wave 2: ChatGPT Layout (Sidebar, ChatLayout components)
- [x] 02-03-PLAN.md — Wave 3: Integration (HomePage wrapped in ChatLayout, persistence connected)
...
**Plans**: 3 plans
**Plan List:**
- [x] 03-01-PLAN.md — Wave 1: Theme system (theme-store, use-theme hook, alert-dialog)
- [x] 03-02-PLAN.md — Wave 2: Sidebar conversation management (new chat, title edit, delete, theme toggle)
- [x] 03-03-PLAN.md — Wave 3: Empty states + auto-title generation
...
| 2. Persistence + Layout | 2/3 | In Progress|  |
| 3. Conversation Management | 0/3 | Not started | - |
