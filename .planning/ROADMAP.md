...
- [x] 01-02-PLAN.md — NestJS backend 셸과 backend-only env 경계를 부트스트랩한다
- [x] 01-03-PLAN.md — React/Vite frontend 셸과 auth 디자인 토큰을 부트스트랩한다
- [x] 01-04-PLAN.md — Prisma SQLite 사용자 저장소와 Nest 모듈 계약을 정의한다
- [x] 01-05-PLAN.md — NestJS 쿠키 JWT 인증 API와 backend auth 테스트를 구현한다
...
- [x] 02-02: 대화 생성 및 목록 조회 API와 프론트 목록 UI를 연결한다
