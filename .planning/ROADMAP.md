...
- [ ] **Phase 1: Foundation** - API 키 관리, 대화방 CRUD, 레이아웃
...
Plans:
- [ ] 01-01: 프로젝트 스캐폴딩 (Vite + React + TypeScript + Tailwind)
- [ ] 01-02: ChatProvider (Context + Reducer) 및 레이아웃 구조
- [ ] 01-03: API 키 입력/검증, 대화방 CRUD, 모델 선택 기능
...
Plans:
- [ ] 02-01: 메시지 입력 컴포넌트 및 전송 로직
- [ ] 02-02: OpenRouter API 연동 및 스트리밍 응답 처리
- [ ] 02-03: 취소 기능, 입력 잠금, 자동 스크롤
...
Plans:
- [ ] 03-01: localStorage 저장/복원 로직 및 오류 처리
