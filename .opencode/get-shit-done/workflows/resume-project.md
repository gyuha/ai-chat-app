...
<required_reading>
@/Users/gyuha/workspace/ai-chat-app.worktrees/simple/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/gyuha/workspace/ai-chat-app.worktrees/simple/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
