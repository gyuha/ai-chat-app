...
- **Global scope**: `/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-glm/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-glm/.claude/notes/`)
...
2. Glob `/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-glm/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-glm/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-glm/.claude/notes/` — works in any directory
