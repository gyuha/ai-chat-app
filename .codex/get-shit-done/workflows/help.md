...
전체 GSD 명령 레퍼런스를 출력합니다. 레퍼런스 내용만 출력하고, 프로젝트별 분석, git 상태, 다음 단계 제안, 그 밖의 추가 코멘터리는 덧붙이지 마세요.
</purpose>
...
- timestamp가 붙은 note를 `.planning/notes/`에 저장합니다 (전역에서는 `/Users/gyuha/workspace/ai-chat-app/.codex/notes/`)
