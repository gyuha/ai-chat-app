<purpose>
한국어 우선 안내: 이 워크플로 자산은 `discovery-phase` 흐름을 한국어 기준으로 먼저 읽을 수 있게 정리합니다. 아래 영문 원문은 upstream 동기화와 세부 의미 보존을 위해 함께 유지합니다.
...
See /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/templates/discovery.md
...
Use /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/templates/discovery.md.
