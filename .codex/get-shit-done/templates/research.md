...
**Purpose:** phase를 잘 구현하기 위해 the agent가 알아야 할 내용을 기록합니다. 단순한 라이브러리 선택이 아니라 전문가들이 실제로 어떻게 구현하는지를 다룹니다.
...
**If no CONTEXT.md exists:** "사용자 제약 없음 - 모든 결정은 the agent 재량"이라고 적습니다.
</user_constraints>
