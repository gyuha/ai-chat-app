...
> 한국어 우선 안내: 이 템플릿은 `phase-prompt` 자산을 한국어 기준으로 먼저 읽을 수 있게 정리합니다. 아래 영문 원문은 upstream 동기화와 세부 의미 보존을 위해 함께 유지합니다.
...
<!-- For checkpoint task examples and patterns, see @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/references/checkpoints.md -->
...
See `/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
