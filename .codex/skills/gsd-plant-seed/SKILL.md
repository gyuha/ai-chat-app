---
name: "gsd-plant-seed"
description: "조건이 맞을 때 떠오를 미래 아이디어 심기"
metadata:
  short-description: "조건이 맞을 때 떠오를 미래 아이디어 심기"
---
...
<execution_context>
@/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/plant-seed.md
</execution_context>

<process>
한국어 우선 안내: 실제 실행 시에는 아래 워크플로와 참조 경로를 그대로 따르되, 설명 해석은 한국어를 기본으로 사용합니다.

Execute the plant-seed workflow from @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/plant-seed.md end-to-end.
</process>
