---
name: "gsd-autonomous"
description: "남은 phase를 discuss→plan→execute로 자동 진행"
metadata:
  short-description: "남은 phase를 discuss→plan→execute로 자동 진행"
---
...
<execution_context>
@/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/autonomous.md
...
Execute the autonomous workflow from @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/autonomous.md end-to-end.
