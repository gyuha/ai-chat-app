...
description: "새 milestone을 시작하고 PROJECT와 requirements 갱신"
metadata:
  short-description: "새 milestone을 시작하고 PROJECT와 requirements 갱신"
---
...
<objective>
한국어 우선 안내: 이 명령 문서는 `$gsd-new-milestone` 흐름을 한국어로 먼저 안내합니다. 아래 영문 원문은 upstream 호환성과 세부 의미 보존을 위해 함께 유지합니다.
...
<execution_context>
@/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/new-milestone.md
...
Execute the new-milestone workflow from @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/new-milestone.md end-to-end.
