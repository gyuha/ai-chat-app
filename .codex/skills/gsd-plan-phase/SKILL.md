---
name: "gsd-plan-phase"
description: "검증 루프가 포함된 상세 phase 계획 생성"
metadata:
  short-description: "검증 루프가 포함된 상세 phase 계획 생성"
---
...
<objective>
한국어 우선 안내: 이 명령 문서는 `$gsd-plan-phase` 흐름을 한국어로 먼저 안내합니다. 아래 영문 원문은 upstream 호환성과 세부 의미 보존을 위해 함께 유지합니다.
...
<execution_context>
@/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/plan-phase.md
...
Execute the plan-phase workflow from @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/plan-phase.md end-to-end.
