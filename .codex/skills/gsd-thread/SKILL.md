---
name: "gsd-thread"
description: "세션 간 persistent context thread 관리"
metadata:
  short-description: "세션 간 persistent context thread 관리"
---
...
5. Commit:
   ```bash
   node "/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: create thread — ${ARGUMENTS}" --files ".planning/threads/${SLUG}.md"
   ```
