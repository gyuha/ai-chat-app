---
name: "gsd-next"
description: "다음 논리적 GSD 단계로 자동 진행"
metadata:
  short-description: "다음 논리적 GSD 단계로 자동 진행"
---
...
<execution_context>
@/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/next.md
</execution_context>

<process>
한국어 우선 안내: 실제 실행 시에는 아래 워크플로와 참조 경로를 그대로 따르되, 설명 해석은 한국어를 기본으로 사용합니다.

Execute the next workflow from @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/next.md end-to-end.
</process>
