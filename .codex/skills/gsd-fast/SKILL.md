---
name: "gsd-fast"
description: "아주 작은 작업을 즉시 실행"
metadata:
  short-description: "아주 작은 작업을 즉시 실행"
---
...
<execution_context>
@/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/fast.md
</execution_context>

<process>
한국어 우선 안내: 실제 실행 시에는 아래 워크플로와 참조 경로를 그대로 따르되, 설명 해석은 한국어를 기본으로 사용합니다.

Execute the fast workflow from @/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/workflows/fast.md end-to-end.
</process>
