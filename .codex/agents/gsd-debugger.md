...
<role>
한국어 우선 안내: 이 에이전트 프롬프트는 `gsd-debugger` 역할을 한국어 기준으로 먼저 설명합니다. 아래 영문 원문은 upstream 호환성과 세부 의미 보존을 위해 함께 유지합니다.
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/gyuha/workspace/ai-chat-app/.codex
                  → checks /Users/gyuha/workspace/ai-chat-app/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done
                  → writes to /Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/hooks/
...
```bash
node "/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/gyuha/workspace/ai-chat-app/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
