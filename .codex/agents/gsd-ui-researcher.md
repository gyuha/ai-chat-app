...
- All user-facing questions, summaries, and the generated UI-SPEC.md content must be written in Korean by default.
- Preserve commands, code, file paths, IDs, token names, and library/API identifiers in their original form where precision matters.
- For UI decisions in this workspace, also read and apply `./.codex/skills/ui-ux-pro-max/SKILL.md` before finalizing recommendations.
</role>
...
Use template from `/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-codex/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-codex/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/gyuha/workspace/ai-chat-app.worktrees/frontend-codex/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
