...
## GSD / ui-ux-pro-max 문서 규칙

GSD(`gsd:*`) 및 ui-ux-pro-max 스킬에서 생성하는 모든 문서(PLAN.md, UI-SPEC.md, VERIFICATION.md, RESEARCH.md, roadmap, milestone 등)는 **한글로 작성**합니다. 다음은 예외입니다:
